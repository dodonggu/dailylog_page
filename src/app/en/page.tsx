...
const homeEditPage = getEditablePage("/en")!;
...
export const metadata = buildMetadata(homePageContentEn.metadata);

export default function EnglishHomePage() {
  const marketingHomeProps = getMarketingHomeProps(homePageContentEn);
    ...
    <HomeReadingShell>
      <MarketingHomePage
        ...
        editAttributes={{
          ...
          scenes: homePageContentEn.scenes.map((scene) => {
      ...
      <HomeDownloadSection
        locale="en"
        content={homePageContentEn.downloadSection}
        editAttributes={{
